	...
	res.render('task21', {
		...
		nested_display: {
			...
			children_display: {
				...
				text: 'tag that have been identified as deprecated and not recommended for use in HTML version 5',
				button: {
					text: 'Орen',
				},
			},
...
router.get('/template-1', function (req, res) {
	...
	res.render('template-1', {
		...
		hero: {
			title: 'Pricing',
			text: `Quickly build an &shy; effective pricing table for your potential customers              
		 with this Bootstrap example. It's built with default Bootstrap components and utilities with little customization.`,
		},
		plans: [
			{
				name: 'Free',
